...
set output 'graphs/elevation-vs-time.png'

# Set plot title and axis labels
set title "Elevation vs Simulation Time"
set xlabel "Simulation Time (s)"
set ylabel "Elevation (rad)"
...
do for [PRN in PRN_list] {
    plot_cmd = plot_cmd . sprintf("'channel-dump.txt' using 1:($8*(filter_prn(2, \"%s\") ? 1 : NaN)):2 with linespoints title 'PRN %s', ", PRN, PRN)
}
...
#    plot 'channel-dump.txt' using 1:($8*(filter_prn(2, "18") ? 1 : NaN)):2 with table title 'PRN 18'
#unset table